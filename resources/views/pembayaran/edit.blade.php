                    ...
                    <form action="{{ route('panelmua.pembayaran.update', $pembayaran->id) }}"
                        ...
                        <div>
                            ...
                            <select name="metode_bayar"
                                    class="w-full border border-slate-300 rounded-xl px-3 py-2 text-sm
                                           focus:outline-none focus:ring-2 focus:ring-rose-300 bg-white">
                        ...
                        <div class="flex flex-wrap gap-3 mt-4 justify-end">
                            ...
                            <button type="submit"
                                    class="px-5 py-2.5 rounded-2xl bg-rose-600 text-white text-xs sm:text-sm font-semibold hover:bg-rose-700 shadow-sm">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
