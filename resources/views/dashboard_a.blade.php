    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-2">
            ...
            <div class="card-soft p-5">
                ...
                <span class="inline-flex items-center px-2.5 py-1 text-[11px] rounded-full mt-2 border
        ...
        @if($pendingRequestsCount > 0)
            <div class="card-soft p-5 bg-gradient-to-r from-[#fff3ea] via-[#ffeef5] to-[#fff6e8] border border-amber-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div class="flex items-start gap-3">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 2 2 20h20L12 2Zm0 5 5 9H7l5-9Zm-1 4v3h2v-3h-2Zm0 4v2h2v-2Z" />
                            </svg>
                        </div>
                        <div>
                    ...
                    <a href="{{ route('admin.mua-requests.index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm text-white
        ...
        <div class="card-soft p-5 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('users.index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm text-white
