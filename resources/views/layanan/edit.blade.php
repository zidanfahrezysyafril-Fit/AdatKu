    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-0">
        <div class="bg-white/95 rounded-3xl shadow-sm ring-1 ring-[#FACC6B]/40 overflow-hidden">
            ...
            <div
                ...
                <a href="{{ route('panelmua.layanan.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium
            ...
            {{-- FORM --}}
            <form action="{{ route('panelmua.layanan.update', $item->id) }}" method="POST" enctype="multipart/form-data"
                class="p-6 sm:p-8 space-y-6 bg-gradient-to-b from-[#FFF8E8]/60 to-transparent">
                @csrf
                @method('PUT')

                @include('layanan._form', ['item' => $item])
                ...
                <div class="flex justify-end gap-3 pt-2">
                    ...
                    <button type="submit" class="px-5 py-2.5 rounded-2xl text-sm font-semibold text-[#7A4600] shadow-md
