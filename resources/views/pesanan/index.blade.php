                                ...
                                <td class="px-4 py-3 align-top">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        @if ($pesanan->status_pembayaran === 'Lunas')
                                            <a href="{{ route('panelmua.pembayaran.create', $pesanan->id) }}" class="inline-flex items-center justify-center px-3 py-1.5 rounded-full text-xs
                                        ...
                                        <form action="{{ route('panelmua.pesanan.updateStatus', $pesanan->id) }}" method="POST"
                                            ...
                                            <select name="status_pembayaran"
                                                ...
                                                <option value="Belum_Lunas" @selected($pesanan->status_pembayaran === 'Belum_Lunas')>
                                                    Belum Lunas
                                                </option>
                                                <option value="Lunas" @selected($pesanan->status_pembayaran === 'Lunas')>
                                                    Lunas
                                                </option>
                                                <option value="Dibatalkan" @selected($pesanan->status_pembayaran === 'Dibatalkan')>
                                                    Dibatalkan
                                                </option>
                                            </select>
