...
<body class="bg-[rgba(255,242,213,0.08)] text-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <form action="{{ route('logout') }}" method="POST" class="inline">
          @csrf
          <button type="submit"
            class="bg-gradient-to-r from-pink-400 via-rose-400 to-red-400 text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg hover:from-rose-500 hover:to-red-500 transition">
            Logout
          </button>
        </form>
        @endauth
  ...
  <section class="relative">
    ...
    <div
      ...
      <p class="text-lg md:text-xl w-11/12 md:w-2/5 text-red-200">Temukan keindahan budaya dan tradisi
        melalui koleksi busana adat, rias, dan pelaminan terbaik.</p>
  ...
  <!-- 🔹 Kotak Melayang: Tombol Login MUA -->
  <div class="fixed left-5 bottom-5 z-50">
    <a href="{{ route('auth') }}"
      class="bg-gradient-to-r from-pink-400 via-rose-400 to-red-400 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl hover:from-rose-500 hover:to-red-500 transition font-medium">
