...
<body class="text-slate-800" x-cloak>
    ...
    <div class="min-h-screen flex bg-transparent">
        ...
        {{-- ===================== SIDEBAR (DARK) ===================== --}}
        <aside
            class="bg-[#151019] border-r border-[#271b33] shadow-[0_0_35px_rgba(0,0,0,0.9)]
                   fixed inset-y-0 left-0 z-40 transform transition-transform duration-200
                   flex flex-col md:static md:translate-x-0"
            :class="openSidebar
                ? 'translate-x-0 w-64'
            ...
            <div class="px-4 py-4 flex items-center gap-3 border-b border-[#271b33]">
                ...
                <div class="flex items-center gap-3" x-show="openSidebar" x-cloak>
                    <div
                        class="w-11 h-11 rounded-full bg-white flex items-center justify-center shadow-md
            ...
            <nav class="px-3 pt-4 flex-1 overflow-y-auto space-y-3 text-sm">
                ...
                {{-- Label grup menu --}}
                <p
                    class="px-3 text-[10px] tracking-[0.18em] uppercase text-slate-400/80 mb-1"
                    x-show="openSidebar"
                    x-cloak>
                    Navigasi Utama
                </p>
                ...
                <a href="{{ route('admin.dashboard') }}"
                   ...
                   @endif">
                    <span
                        class="w-8 h-8 rounded-xl flex items-center justify-center border text-xs transition
                        @if(request()->routeIs('admin.dashboard'))
                ...
                <p
                    class="px-3 pt-3 text-[10px] tracking-[0.18em] uppercase text-slate-400/80"
                    x-show="openSidebar"
                    x-cloak>
                    Manajemen Data
                </p>
            ...
            <div
                class="px-4 py-3 border-t border-[#271b33] text-[11px] text-[#f2d49a] hidden md:block"
                x-show="openSidebar"
                x-cloak>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            {{-- TOPBAR TERANG --}}
            <header
                class="bg-[#fff7ed]/95 border-b border-amber-100 shadow-[0_6px_20px_rgba(190,120,40,0.15)]
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <h1 class="text-base md:text-xl font-semibold text-slate-900 flex items-center gap-2">
                                ...
                                <span
                                    class="inline-flex items-center px-2 py-[2px] rounded-full text-[11px]
