  ...
  <div class="min-h-screen flex">
    ...
    <aside :class="openSidebar ? 'w-64' : 'w-20'"
      ...
      <div class="px-4 py-4 flex items-center gap-3 border-b border-[#271b33]">
        ...
        {{-- Tombol garis 3 (selalu ada) --}}
        <button @click="openSidebar = !openSidebar" class="p-2 rounded-xl hover:bg-[#241726] text-[#f6c86c] transition">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M4 6h16v2H4V6Zm0 5h16v2H4v-2Zm0 5h16v2H4v-2Z" />
          </svg>
        </button>

        {{-- Logo + teks (logo selalu kelihatan, teks hanya saat sidebar terbuka) --}}
        <div class="flex items-center gap-3" x-show="openSidebar">
          {{-- Logo bulat putih ala MUA Panel --}}
          ...
          {{-- Teks brand, sembunyi kalau sidebar di-collapse --}}
      ...
      <nav class="px-3 pt-4 flex-1 overflow-y-auto space-y-2 text-sm">
        ...
        {{-- Dashboard --}}
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl
                    ...
                    @endif">
          <span class="w-8 h-8 rounded-xl flex items-center justify-center border
                        @if(request()->routeIs('admin.dashboard'))
        ...
        {{-- Users --}}
        <a href="{{ route('users.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl
          ...
          <span class="w-8 h-8 rounded-xl flex items-center justify-center border
                        ...
                        @endif">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm0 2c-3.33 0-6 1.34-6 4v2h12v-2c0-2.66-2.67-4-6-4Z" />
            </svg>
          </span>
        ...
        {{-- Pesan Kontak --}}
        <a href="{{ route('admin.contact.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl
        ...
        {{-- Request MUA --}}
        <a href="{{ route('admin.mua-requests.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl
    ...
    <div class="flex-1 flex flex-col">
      ...
      {{-- TOPBAR TERANG --}}
      <header
        class="bg-[#fff7ed]/95 border-b border-amber-100 shadow-[0_6px_20px_rgba(190,120,40,0.15)] sticky top-0 z-30 backdrop-blur">
