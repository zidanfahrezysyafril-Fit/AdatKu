...
<body class="relative min-h-screen bg-gradient-to-b from-[#fff7e1] via-[#f4d890] to-[#cfa043] overflow-hidden">
    ...
    {{-- CARD LOGIN – SAMA PETAKNYA DENGAN REGISTER --}}
        ...
        <div class="w-full max-w-4xl bg-[#fffdf7]/95 rounded-[32px]
            ...
            <div class="grid md:grid-cols-2">
                ...
                <div class="px-10 py-10 md:py-12 flex flex-col justify-center">
                    ...
                    {{-- FORM LOGIN (ISI BEDA, PETAK SAMA) --}}
                    <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between text-xs text-gray-700">
                            <label class="inline-flex items-center gap-2">
                                <input type="checkbox" name="remember" class="rounded border-[#efcd82]">
                                <span>Remember me</span>
                            </label>
                            {{-- <a href="#" class="text-[#d68e00] font-semibold hover:underline">Lupa password?</a> --}}
                        </div>
                ...
                {{-- KOLOM KANAN: TEKS (SAMA PERSIS DENGAN REGISTER) --}}
