...
@section('content')
  ...
  <div class="min-h-[calc(100vh-4rem)] bg-transparent">
    <div class="max-w-6xl mx-auto px-4 md:px-8 py-6 space-y-6">
      ...
      {{-- HEADER / WELCOME --}}
      <div
        class="relative overflow-hidden rounded-3xl border border-rose-100 bg-gradient-to-r from-[#fff3f5] via-[#fff8ef] to-[#fff4fa] px-6 py-5 md:px-8 md:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="relative">
          <p class="text-[10px] md:text-xs uppercase tracking-[0.2em] adat-gold mb-1">
            MUA Panel
          </p>

          <h1 class="text-2xl md:text-3xl font-semibold adat-title">
            Halo,
          ...
          <p class="text-xs md:text-sm adat-text mt-2">
        ...
        <div class="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          <a href="{{ route('profile.show') }}"
            class="inline-flex items-center justify-center px-4 py-2 rounded-full border border-[#f5c86b] bg-white/80 text-xs md:text-sm hover:bg-amber-50 transition adat-gold">
            Kelola Profil
          </a>
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-rose-50 px-6 py-5">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h2 class="text-base font-semibold adat-gold">Ringkasan Pesanan</h2>
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-rose-50 px-6 py-5 h-full flex flex-col">
            <div class="flex items-center justify-between mb-3">
              <div>
                ...
                <h2 class="text-base font-semibold adat-title">Bulan Ini</h2>
              </div>
              <span
            ...
            <p class="text-3xl font-semibold adat-jade">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-rose-50 px-6 py-5 stat-card">
        <div class="flex items-center justify-between mb-3">
          <h2 class="text-base font-semibold adat-gold">Pesanan Terbaru</h2>
        ...
        @if(($pesananTerbaru ?? collect())->isEmpty())
          ...
          <div class="relative py-10 px-4 text-center overflow-hidden">
            ...
            @foreach($pesananTerbaru as $pesanan)
              <div class="border border-slate-100 rounded-xl px-3 py-2.5 hover:bg-rose-50/40 transition">
                <div class="flex items-center justify-between">
                  ...
                  <span
                    class="inline-flex items-center rounded-full bg-slate-50 px-2.5 py-0.5 text-[11px] border border-slate-100 adat-text">
