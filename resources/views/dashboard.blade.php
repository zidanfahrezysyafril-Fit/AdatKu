      ...
      <aside :class="open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'" class="w-64 bg-[#2a2330] text-white transition-transform duration-200 flex-shrink-0 h-[calc(100vh-4rem)] fixed lg:static">
        <div class="flex flex-col h-full">
          ...
          <nav class="flex-1 px-4 py-3 space-y-1 text-sm">
            <a href="{{ route('dashboard') }}" class="block px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 transition">Dashboard</a>
            <a href="{{ route('users.index') }}" class="block px-4 py-2 rounded-lg hover:bg-white/10 transition">Users</a>
            <a href="{{ route('settings') }}" class="block px-4 py-2 rounded-lg hover:bg-white/10 transition">Settings</a>
          </nav>
